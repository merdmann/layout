...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var SEC = 1000; // 1 sec in milisecs
    var K = 273.15;
    /*
    ...
    function Search(name) {
        ...
        city_js_1["default"].forEach(function (city) {
    ...
    /* start and pick what is requested on the screen */
    function main(id) {
        var _search_text_ = document.getElementById("search-text").text;
     ...
     */
    function ToC(x) {
        return parseFloat((x - K).toFixed(0));
    }
    ...
    function appendRow(str, row) {
        var result = str + "<div class=\"row text-center\"> ";
